...
@Value.Immutable
public abstract class MapBasedOperatorIfcResolver implements OperatorIfcResolver {
	...
	public static ImmutableMapBasedOperatorIfcResolver.Builder builder() {
		return ImmutableMapBasedOperatorIfcResolver.builder();
	}
}
